...
eight_plots <- plot_grid(hr_dea, hr_deb, hr_dec, hr_ded, hr_dee, hr_def, labels = c("10A. DE Genes", "10B. Non-DE genes", "10C.", "10D.", "10E.", "10F.", label_y = 0), ncol = 2)
plot_fig4 <- plot_grid(eight_plots, ncol = 1, rel_heights=c(0.1, 1))

save_plot("/Users/laurenblake/Desktop/tissue_paper/test7.pdf", plot_fig4,
