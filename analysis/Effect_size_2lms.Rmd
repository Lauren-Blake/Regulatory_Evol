...
hc_heart_DE_make_plot <- as.data.frame(effect_size_hc_species_DE(c(1, 5, 9, 13, 20, 24, 28), 0.05, 0.05))
...
p5 <- plot(x=hc_heart_DE_make_plot[,1], y=hc_heart_DE_make_plot[,2],
     ylab = "Standard error of the difference",
     xlab = "Difference in effect size from 2 lms", 
     main = " ",
     pch=16, cex=.6, col = hc_heart_DE_make_plot[,3])
...
p6 <- plot(x=hc_heart_non_DE_make_plot[,1], y=hc_heart_non_DE_make_plot[,2],
     ylab = "Standard error of the difference",
     xlab = "Difference in effect size from 2 lms", 
     main = " ",
     pch=16, cex=.6, col = hc_heart_non_DE_make_plot[,3])
...
p1 <- plot(x=hk_DE_make_plot[,1], y=hk_DE_make_plot[,2],
     ylab = "Standard error of the difference",
     xlab = "Difference in effect size from 2 lms", 
     main = " ",
     pch=16, cex=.6, col = hk_DE_make_plot[,3])
...
p2 <- plot(x=hk_make_plot[,1], y=hk_make_plot[,2],
     ylab = "Standard error of the difference",
     xlab = "Difference in effect size from 2 lms", 
     main = " ",
     pch=16, cex=.6, col = hk_make_plot[,3])
...
p3 <- plot(x=hk_DE_make_plot[,1], y=hk_DE_make_plot[,2],
     ylab = "Standard error of the difference",
     xlab = "Difference in effect size from 2 lms", 
     main = " ",
     pch=16, cex=.6, col = hk_DE_make_plot[,3])
...
p4 <- plot(x=hk_make_plot[,1], y=hk_make_plot[,2],
     ylab = "Standard error of the difference",
     xlab = "Difference in effect size from 2 lms", 
     main = " ",
     pch=16, cex=.6, col = hk_make_plot[,3])
