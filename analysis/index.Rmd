...
This this the project website for Blake, Roux, et al., "A comparison of gene expression and DNA methylation patterns across tissues and species". Many of the main conclusions from each section are quoted directly from the [publication](https://genome.cshlp.org/content/30/2/250.long). 
A link to the Github repo can be found [here](https://github.com/Lauren-Blake/Regulatory_Evol/tree/gh-pages), although the code is much more readable using the links below.  
...
*  Conclusion from this section: There is a sufficient number of (orthologous) reads per sample to proceed with the analysis. 
...
*  Conclusion from this section:  For each tissue-species pair, the adjusted raw counts and the actual raw counts were highly correlated (> 0.98). Therefore, I did not adjust for read depth or GC content in the RNA-sequencing data. 
...
*  [Part 1: Identifying variables potentially confounded with biological variables of interest.](../analysis/Tech_factor_analysis1_gene_exp.html) As described in [Gilad and Mizrahi-Man et al 2015](https://f1000research.com/articles/4-121), study design is imperative in primate comparative genomics. In this study, I took extra care to record and analyze non-biological variables of interest. 
...
*  [Defining DMRs based on the base pair (bp) overlap.](../analysis/Finding_DMRs.html)
*  [Identifying human-specific and conserved DMRs using the package bedr.](../analysis/Pairwise_tDMRs.html)
...
* [Correlations of gene expression levels in tissues from matched versus unmatched individuals.](../analysis/gene_exp_corr.html)
...
* [Additional H3K27ac analysis, including GO enrichment.](../analysis/Revisions_H3K27ac.html)
* [Comparing gene expression levels with reads mapped using the HG19 versus HG38 genome builds.](../analysis/Revisions_genomes.html)
* [Network analysis.](../analysis/revisions_networks.html)
* [Obtain the number of genes per tissue.](../analysis/revisions_misc.html)
