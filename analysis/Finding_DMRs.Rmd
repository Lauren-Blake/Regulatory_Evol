...
conserved_tdmr_heart_liver_heart_lung <- c(5472, 5189, 5007, 4824, 4400, 3858, 3275, 2636, 2305,1964,1338, 974)
perc_overlap <- c(0.1, 0.2, 0.25, 0.3, 0.4, 0.5, 0.6, 0.7, 0.75, 0.80, 0.90, 1)
...
conserved_tdmr_heart_liver_heart_lung_bp <- c(419, 440, 454, 470, 500, 533, 574, 601, 604,599,522, 410.5)
perc_overlap <- c(0.1, 0.2, 0.25, 0.3, 0.4, 0.5, 0.6, 0.7, 0.75, 0.80, 0.90, 1)
...
# Plot the number of tDMRs
conserved_tdmr_heart_liver_heart_lung <- c(2275, 1998, 1870, 1739, 1451, 1155, 866, 632, 507,426,294, 234)
perc_overlap <- c(0.1, 0.2, 0.25, 0.3, 0.4, 0.5, 0.6, 0.7, 0.75, 0.80, 0.90, 1)
...
# Plot the median tDMR length
conserved_tdmr_heart_liver_heart_lung_bp <- c(321, 357, 376, 394, 429, 467, 498.5, 503.5, 514, 475.5, 390.5, 340)
perc_overlap <- c(0.1, 0.2, 0.25, 0.3, 0.4, 0.5, 0.6, 0.7, 0.75, 0.80, 0.90, 1)
...
# Plot the number of tDMRs
conserved_tdmr_heart_liver_heart_lung <- c(3837, 3614, 3472, 3332, 2974, 2607, 2180, 1740, 1502,1254,854, 621)
perc_overlap <- c(0.1, 0.2, 0.25, 0.3, 0.4, 0.5, 0.6, 0.7, 0.75, 0.80, 0.90, 1)
...
# Plot the median tDMR length
conserved_tdmr_heart_liver_heart_lung_bp <- c(433, 459.5, 477.5, 491, 533.5, 560, 597, 608, 612,589,537.5, 428)
perc_overlap <- c(0.1, 0.2, 0.25, 0.3, 0.4, 0.5, 0.6, 0.7, 0.75, 0.80, 0.90, 1)
...
# Plot the number of tDMRs
conserved_tdmr_heart_liver_heart_lung <- c(3521, 3246, 3084, 2931, 2577, 2229, 1859, 1478, 1288,1101,738, 527)
perc_overlap <- c(0.1, 0.2, 0.25, 0.3, 0.4, 0.5, 0.6, 0.7, 0.75, 0.80, 0.90, 1)
...
# Plot the median tDMR length
conserved_tdmr_heart_liver_heart_lung_bp <- c(418, 450.5, 473, 497, 533, 564, 590, 619.5, 621,602,501, 378)
perc_overlap <- c(0.1, 0.2, 0.25, 0.3, 0.4, 0.5, 0.6, 0.7, 0.75, 0.80, 0.90, 1)
...
## Heart versus liver and heart versus kidney


## Heart versus liver and liver versus lung


## Heart versus liver and liver versus kidney


## Heart versus liver and kidney versus lung



## Heart versus lung and Heart versus kidney

## Heart versus lung and liver versus kidney

## Heart versus lung and liver versus lung

## Heart versus lung and kidney versus lung


## Heart versus kidney and liver versus kidney

## Heart versus kidney and liver versus lung

## Heart versus kidney and kidney versus lung


## Liver versus kidney and liver versus lung

## Liver versus kidney and kidney versus lung


## Liver versus lung and kidney versus lung
