...
## Aug 20, 2015
# - Run on spudhead
# - Launches overlap_contrast_specific_features_DMRs.pl for all DMRs, and all the random DMRs files of same length /CpG density
...
foreach my $file (@files){
  ...
  # launch script overlap_contrast_specific_features_DMRs.pl: already done by launch_overlap_contrast_specific_features_DMRs.pl
